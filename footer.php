...
<footer class="footer">
    ...
    <div class="footer__logo img__wrapper">
        <img class="logo__img" src="/images/loga.png" alt="Logo">
    </div>
    <div class="footer__socialmedia">
        <div class="img__wrapper icon-parent">
            <img class="socialmedia__img" src="/images/1x/insta.png" alt="Instagram">
        </div>
        <div class="img__wrapper icon-parent">
            <img class="socialmedia__img" src="/images/1x/faceb.png" alt="facebook">
        </div>
        <div class="img__wrapper icon-parent">
            <img class="socialmedia__img" src="/images/1x/twitter.png" alt="Twitter">
        </div>
    </div>
</footer>
